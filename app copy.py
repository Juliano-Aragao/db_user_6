...
def cadastrar_postgres():
    ...
    try:
        ...
        # Exibir imagem de confirmação
        st.image("img/emoji-joinha.jpeg", width=100)  # ajuste o caminho e o tamanho conforme necessário
        # Limpar campos
        for campo in ["nome", "sobrenome", "cpf","senha"]:
            st.session_state[campo] = ""
...
def buscar_cadastros():
    try:
        ...
        # Formatar CPF para exibição: 12345678901 -> 123.456.789-01
...
def limpar():
    for campo in ["nome", "sobrenome", "cpf"]:
        st.session_state[campo] = ""


# Criar um container para mensagens e histórico
...
with col3:
    st.text_input("Digite a senha", type="password", key="senha")
